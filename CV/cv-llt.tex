...
\leftheader{%
  {\LARGE\bfseries\sffamily Vladimir Cherepanov}

  \makefield{\faEnvelope[regular]}{\href{mailto:keltecc@ya.ru}{\texttt{keltecc@ya.ru}}}
  ...
  \makefield{{\scriptsize\simpleicon{x}}}{\!\href{https://x.com/keltecc}{\texttt{@keltecc}}}
  \makefield{\faLinkedin}
  {\href{http://www.linkedin.com/in/keltecc/}{\texttt{keltecc}}}

  %% Next line
  \makefield{\faGlobe}{\url{http://blog.kelte.cc/}}
